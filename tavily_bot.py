...
if "conversation" not in st.session_state:
    st.session_state["conversation"] = []  # Store Q&A history

if "scraped" not in st.session_state:
    st.session_state["scraped"] = False  # Ensure scraping happens only once per session

# Function to load scraped data from file
def load_scraped_data():
    """Reads scraped website data from file."""
...
def query_openai(scraped_text, user_input):
    """Processes user query with OpenAI API."""
...
if audio_bytes:
    ...
    # Process Speech-to-Text in the Background
